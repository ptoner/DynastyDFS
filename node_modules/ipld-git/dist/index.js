...
var multicodecs = __webpack_require__(70);

var multihash = __webpack_require__(4);

var CID = __webpack_require__(18);

var strftime = __webpack_require__(71);
...
var timestampWithOffsetToISOStrict = function timestampWithOffsetToISOStrict(timestamp, offset) {
  return strftime.timezone(offset)(ISO_8601_STRICT, new Date(timestamp * 1000));
};

var isoStrictToTimestampWithOffset = function isoStrictToTimestampWithOffset(isoString) {
  var matched = isoString.match(/([+-]\d{2}:\d{2})/);
  var offset = matched === null ? '+0000' : matched[0].slice(0, 3) + matched[0].slice(4);
...
var utils_1 = __webpack_require__(69); // The default Buffer size if one is not provided.
...
var commit = __webpack_require__(72);

var tag = __webpack_require__(73);

var tree = __webpack_require__(74);
...
var CIDUtil = __webpack_require__(66);
...
var traverse = __webpack_require__(68);
...
exports.print = __webpack_require__(65);
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(0).Buffer))
...
exports.serialize = function (dagNode, callback) {
  ...
  entries.sort(function (a, b) {
    var aName = a[0] + (a[1].mode === '40000' ? '/' : '');
    var bName = b[0] + (b[1].mode === '40000' ? '/' : '');
